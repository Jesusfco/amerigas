        ...
        <div class="col-md-10 col-md-offset-1 ">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('registros.update', $reporte->id) }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group {{ $errors->has('fecha') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="date" class="form-control" name="date" value="{{ $reporte->fecha_descarga }}" required>
                        ...
                        <div class="form-group{{ $errors->has('lugar') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input onfocusout="upper(this)" type="text" class="form-control" name="lugar" value="{{ $reporte->lugar }}" required>
                        ...
                        <div class="form-group{{ $errors->has('hora_camion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="time" class="form-control" name="hora_camion" value="{{ $reporte->hora_camion }}">
                        ...
                        <div class="form-group{{ $errors->has('hora_descarga') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="time" class="form-control" name="hora_descarga" value="{{ $reporte->hora_descarga }}">
