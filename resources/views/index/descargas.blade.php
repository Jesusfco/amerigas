<div id="pdf">
    ...
    <br><br>
    <h1 class="center fat">PDF</h1>
    <div class="pdfcontainer">
        <div class="pdfIcon">
            <img src="{{ url('images/pdf_icon.png') }}" >
        </div>
        <div class="pdfArchives">

            <a class="btn light-blue darken-2" href="pdf/PERMISO_SENER_DIESEL.pdf" target="_blank">Permiso Sener Diesel<i class="material-icons">play_for_work</i></a>
            <a class="btn light-blue darken-2" href="pdf/PERMISO_SENER_GAS_LICUADO.pdf" target="_blank">PERMISO SENER GAS LICUADO<i class="material-icons">play_for_work</i></a>
            <a class="btn light-blue darken-2" href="pdf/PERMISO_SENER_GASAVION.pdf" target="_blank">PERMISO SENER GASAVION<i class="material-icons">play_for_work</i></a>
